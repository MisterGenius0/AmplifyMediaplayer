    ...
    return Padding(
          ...
          Column(
            ...
            children: [
              ...
              if (context.watch<MediaProvider>().currentSongPath != null && MediaQuery.of(context).size.height > 250 )
                Slider(
                  activeColor:
              ...
              if(context.watch<MediaProvider>().currentSongPath != null && MediaQuery.of(context).size.width < 750 && MediaQuery.of(context).size.width > 270)
                const Padding(
                    padding: EdgeInsets.symmetric(vertical: 10.0),
                    child: AmplifyingMediaControls()
                ),
              if (context.watch<MediaProvider>().currentSongPath != null  && MediaQuery.of(context).size.height > 300 )
                Padding(
