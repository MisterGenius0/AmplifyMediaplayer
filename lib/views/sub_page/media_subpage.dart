...
/// TODO add code from source subpage to support late image generation
void Code()
{

}

/// TODO have this functions avalible for all grid subpages (source, media and groups) all use same function for continutity
Widget Loading(BuildContext context, var snapshot)
{
  return Column(
    mainAxisAlignment: MainAxisAlignment.center,
...
Widget Error (BuildContext context, var snapshot)
{
  return Column(
    mainAxisAlignment: MainAxisAlignment.center,
    crossAxisAlignment: CrossAxisAlignment.center,
